...
const getPlaceAbscissOnSemiLineQuestion: QuestionGenerator<
  Identifiers
> = () => {
...
export const placeAbscissOnSemiLine: Exercise<Identifiers> = {
  id: "placeAbscissOnSemiLine",
  label: "Placer un point d'abscisse donnée sur une demi-droite graduée",
  isSingleStep: true,
  generator: (nb: number) =>
    getDistinctQuestions(getPlaceAbscissOnSemiLineQuestion, nb),
  ggbTimer: 60,
  isGGBAnswerValid,
