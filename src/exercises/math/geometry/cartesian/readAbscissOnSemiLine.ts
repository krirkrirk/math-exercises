...
const getReadAbscissOnSemiLineQuestion: QuestionGenerator<Identifiers> = () => {
...
export const readAbscissOnSemiLine: Exercise<Identifiers> = {
  id: "readAbscissOnSemiLine",
  connector: "=",
  label: "Lire une abscisse sur une demi-droite graduée",
  isSingleStep: true,
  generator: (nb: number) =>
    getDistinctQuestions(getReadAbscissOnSemiLineQuestion, nb),
  qcmTimer: 60,
  freeTimer: 60,
  ggbTimer: 60,
  getPropositions,
