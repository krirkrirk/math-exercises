...
const getParallelepipedVolumeQuestion: QuestionGenerator<Identifiers> = () => {
  ...
  const question: Question<Identifiers> = {
    answer: volume,
    instruction: `Calculez le volume d'un parallélépipède avec une longueur de $${length}$ cm, une largeur de $${width}$ cm, une hauteur de $${height}$ cm. La figure ci-dessous représente le parallélépipède.`,
